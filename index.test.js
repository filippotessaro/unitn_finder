...
test ('API get function allCourses',() => {
  getCorsi()
    .then((corsi) => {
      ...
      corso = corso.concat('{"corso":"Innovation and Entrepreneurship studies in ICT"},');
      ...
      corso = corso.concat('{"corso":"Algoritmi e strutture dati (I UD)"},');
      corso = corso.concat('{"corso":"Algoritmi e strutture dati (II UD)"},');
      corso = corso.concat('{"corso":"Fondamenti di algoritmi e strutture dati"},');
      corso = corso.concat('{"corso":"Project course "},');
      corso = corso.concat('{"corso":"Research Project"},');
      corso = corso.concat('{"corso":"Scientific Programming"},');
      corso = corso.concat('{"corso":"Advanced Natural Language Processing and Information Retrieval"},');
